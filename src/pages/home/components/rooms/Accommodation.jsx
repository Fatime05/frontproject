        ...
        <div className={style.context}>
            ...
            <div className={style.firstroom}>
                ...
                <div className={style.text}>
                    <p className={style.hood}>Standard room with balcony</p>
                    <hr />
            ...
            <div className={style.secondroom}>
                ...
                <div className={style.text}>
                    <p className={style.hood}>Standard with Terrace</p>
                    <hr />
            ...
            <div className={style.thirdroom}>
                ...
                <div className={style.text}>
                    <p className={style.hood}>Room for 4 persons category Superior Room</p>
                    <hr />
            ...
            <div className={style.fifthroom}>
                ...
                <div className={style.text}>
                    <p className={style.hood}>Family Room for 3 persons with balcony</p>
                    <hr />
            ...
            <div className={style.sixthroom}>
                ...
                <div className={style.text}>
                    <p className={style.hood}>Family room with terrace</p>
                    <hr />
            ...
            <div className={style.seventhroom}>
                ...
                <div className={style.text}>
                    <p className={style.hood}>King Suite room for 4 persons</p>
                    <hr />
